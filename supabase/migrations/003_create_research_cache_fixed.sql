...
DROP TABLE IF EXISTS canvas_research_cache CASCADE;
...
CREATE INDEX idx_research_cache_doctor ON canvas_research_cache(doctor_name);
CREATE INDEX idx_research_cache_created ON canvas_research_cache(created_at);
CREATE INDEX idx_research_cache_expires ON canvas_research_cache(expires_at);
